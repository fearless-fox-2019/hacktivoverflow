<template>
    <div>
        <p>Ini My Post</p>
        <div v-if="page === true">
            <EditQuestion :dataEdit="getDetail" :pages="true"></EditQuestion>
        </div>
        <div v-for="(data, index) in MyPost" :key="index">
            <b-row>
                <b-col sm="1">
                ...
                <b-col sm="11">
                    ...
                    <b-row>
                        ...
                        <b-col sm="3">
                            <b-row id="prof">
                                <p @click="editQuestion(data._id)" v-b-popover.hover="'you can only edit yours question'"><i class="fas fa-edit"></i></p>
                                <p @click="deleteQuestion(data._id)" v-b-popover.hover="'you can only delete yours question'"><i class="fas fa-trash"></i></p>
                                <b-col sm="6">
                                    <p></p>
