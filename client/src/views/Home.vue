  ...
  <div class="home my-containter container row">
    ...
    <div class="col-sm-8">
      <div class="col-sm-8 d-flex justify-content-between align-items-end header-all-question">
        <div><h4 slot="header" style="margin: 0;">All Questions</h4></div>
    ...
    <div class="col" style="padding-top: 85px; padding-left: 5px; padding-right: 5px; padding-bottom: 5px; background-color: #E5E6E7; margin-bottom: 50px">
      <QuestionList
