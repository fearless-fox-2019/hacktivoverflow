<template>
  <div class="detail-question">
      ...
      <b-row>
        <b-col cols="10">
          ...
          <div class="question-detail">
            ...
            >by : {{detailQuestion.UserId.firstname}} {{detailQuestion.UserId.lastname}}</span>
            <button v-b-modal.modal-update v-if="detailQuestion.UserId.email == email">
              <i class="fa fa-edit"></i>
            </button>
            <button
              v-if="detailQuestion.UserId.email == email"
    ...
    <!-- modal -->
    <b-modal id="modal-update" ref="modal" title="Update">
      <b-form @submit.prevent="updateQuestion">
        <b-form-group
          id="title-question-update"
          label="Title:"
        ...
        <wysiwyg style="margin-top : 20px;"  v-model="detailQuestion.question"/>
        <b-form-group id="tags-update-question" label="Tags:" label-for="tag-update">
          <b-form-input id="tag-update" v-model="question.tags" placeholder="seperated with comma ex:Javascript,Mongoose,node.js"></b-form-input>
        </b-form-group>
